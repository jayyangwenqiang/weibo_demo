...
public class RetweentBodyGridViewAdapter extends BaseAdapter {

	Context mContext;
	List<RetweetedStatusBean.PicUrlsBean> mList;
	String thumbnail_pic;
	RetweetedStatusBean bean;

	public RetweentBodyGridViewAdapter(Context mContext,
			List<RetweetedStatusBean.PicUrlsBean> pic_url, RetweetedStatusBean bean2) {
	...
	private class MyClickListener implements OnClickListener {
		...
		public MyClickListener(RetweetedStatusBean bean, int position) {
			this.bean = bean;
