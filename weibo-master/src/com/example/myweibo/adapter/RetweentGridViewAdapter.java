...
public class RetweentGridViewAdapter extends BaseAdapter {

	Context mContext;
	List<WeiboBean.StatusesBean.RetweetedStatusBean.PicUrlsBean> mList;
	String thumbnail_pic;
	RetweetedStatusBean bean;

	public RetweentGridViewAdapter(
			Context mContext,
			List<WeiboBean.StatusesBean.RetweetedStatusBean.PicUrlsBean> pic_url,
			RetweetedStatusBean bean2) {
	...
	private class MyClickListener implements OnClickListener {
		...
		public MyClickListener(WeiboBean.StatusesBean.RetweetedStatusBean bean,
				int position) {
			this.bean = bean;
